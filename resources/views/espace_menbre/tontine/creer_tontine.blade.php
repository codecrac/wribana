                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{route('espace_menbre.post_ajouter_tontine')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="number" onkeypress="return onlyNumberKey(event)" id="input_montant" min="{{ ($la_session['code_devise'] == 'XOF') ? '1000' : '5'  }}" class="form-control" name="montant" placeholder="17500">
                            </div>
                            <div class="form-group">
