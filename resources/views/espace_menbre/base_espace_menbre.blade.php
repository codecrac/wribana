                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="/template_menbre/images/faces/face4.jpg" alt="image" class="profile-pic">
                            </div>
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="/template_menbre/images/faces/face2.jpg" alt="image" class="profile-pic">
                            </div>
                            <div class="item-content flex-grow">
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="/template_menbre/images/faces/face3.jpg" alt="image" class="profile-pic">
                            </div>
                            <div class="item-content flex-grow">
