                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    {{-- <input required class="text-danger form-control" placeholder="prefix" type="number" onkeypress="return onlyNumberKey(event)" name="prefixe" value="{{$code_prefixe}}" required /> --}}
                                ...
                                <tbody>
                                    @foreach($le_menbre->historique_retraits as $item_retrait)
                                        <tr>
                                            ...
                                            <td>{{number_format($item_retrait->montant_retirer,0,',',' ')}} {{$le_menbre->devise_choisie->monaie}}</td>
    ...
    @else
        ...
        <div class="row">
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=recharger">Recharger mon compte</a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=retirer"> Retirer de l’argent </a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=transferer">Transférer à un compte WARIBANK</a>
            </div>
            
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=h_rechargement">Mes rechargements</a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=h_virement">Virement de tontine</a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=h_t_recus">Transferts recus</a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=h_t_effectue">Tranferts effectués</a>
            </div>
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="{{route('espace_menbre.index_waribank',[$la_session['id']] ) }}?action=h_retrait">Mes retraits</a>
            </div>
        </div>
    @endif
