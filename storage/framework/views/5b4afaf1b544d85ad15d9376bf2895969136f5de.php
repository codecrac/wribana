        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <a href="<?php echo e(route('connexion_menbre')); ?>" class="main-btn wow fadeInUp" data-wow-delay="0.5s">
            ...
            <div class="container primary-bg" style="padding-bottom:50px">
                <div class="row counter-boxes justify-content-xl-between justify-content-center">
                        ...
                        <div class="col-md-5 text-center">
                                <a class="main-btn btn-blanc fadeInLeft wow m-2" href='<?php echo e(route('comment_ca_marche')); ?>'> En savoir plus </a>
                                <a class="main-btn btn-blanc fadeInRight wow m-2" href='<?php echo e(route('inscription_menbre')); ?>'>S'inscrire </a>
                        </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="content white-color text-center">
                        <div class="count-wrap" style="display:block">
                            <h1 class="text-white fadeInUp wow petit_text_on_mobile">
                                ...
                                <br/>
                                <span class="count-down"><?php echo e($frais_de_gestion); ?></span>
                                <span class="suffix">%</span>
                                seulement
                            </h3>
                            <a class="main-btn wow fadeInRight" data-wow-delay="0.5s" style="background-color:#fff;color:#22f" href='<?php echo e(route('inscription_menbre')); ?>'>S'inscrire </a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('base_front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\yvess\Desktop\waribana\resources\views/welcome.blade.php ENDPATH**/ ?>