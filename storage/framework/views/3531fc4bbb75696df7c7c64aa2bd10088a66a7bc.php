...
<?php $__env->startSection('style_complementaire'); ?>
    <link
        rel="stylesheet"
			...
			<div class="row align-items-center justify-content-center">
				<div class="col-md-5">
                    ...
                    <div class="about-text mb-lg-50">
						...
						<div class="container">
                            <form class="form-group" method="post" action="<?php echo e(route('post_inscription_menbre')); ?>">
                    ...
                    <!-- ------------------------UTILE POUR CARTE BANCAIRE -->
                                    <!-- <div style="display:<?php echo e(($country_code!='') ? 'none' : ''); ?>;background-color:yellow"> -->
                                    <div style="">
                                        <label>CODE PAYS (CI,US...) *</label>
                                            <input required class="form-control text-uppercase" placeholder="CI,US" type="text" value="<?php echo e($country_code); ?>" maxLength='2' name="pays" />
                                        <br/>
                                    </div>
                                    
                                    <div class="form-group" style="display:<?php echo e(($country_code != 'US') ? 'none' : ''); ?>">
                                    <!--<div class="form-group">-->
                                    ...
                                    <label>Ville *</label>
                                        <input required class="form-control text-uppercase"  value="<?php echo e($ville); ?>" placeholder="ABIDJAN" value="" type="text" name="ville" />
                                    <br/>
                        ...
                        <!-- / ------------------UTILE POUR CARTE BANCAIRE -->
                                    ...
                                    <br/><br/>
                                    <h6>
                                        <a href="<?php echo e(route('connexion_menbre')); ?>">déja membre ? connectez vous.</a>
                                    </h6>
                                </div>
                            </form>
                        </div>
...
<?php $__env->startSection('script_complementaire'); ?>
    <script>
...
<?php echo $__env->make('base_front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/waribana/public_html/resources/views/inscription_menbre.blade.php ENDPATH**/ ?>