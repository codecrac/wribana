...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        ...
        <div class="row">
            ...
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="<?php echo e(route('espace_menbre.index_waribank',[$la_session['id']] )); ?>?action=transferer">Transférer à un compte WARIBANK</a>
            </div>
            ...
            <div class='col-md-4 mb-3'>
                <a class="btn btn-primary" href="<?php echo e(route('espace_menbre.index_waribank',[$la_session['id']] )); ?>?action=h_t_effectue">Tranferts effectués</a>
            </div>
            <div class='col-md-4 mb-3'>
...
<?php echo $__env->make('espace_menbre.base_espace_menbre', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\yvess\Desktop\waribana\resources\views/espace_menbre/profil/waribank.blade.php ENDPATH**/ ?>