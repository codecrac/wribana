        ...
        <div class=" col-md-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary" href="<?php echo e(route('admin.details_waricrowd',[$le_crowd->id])); ?>">RETOUR</a>
                </div>
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="<?php echo e(route('espace_menbre.post_editer_crowd',[$le_crowd->id])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group" >
                            <label for="exampleInputUsername1">Objectif de financement (Montant)  en <b><?php echo e($le_crowd->createur->devise_choisie->nom); ?></b> *</label>
                        ...
                        <h3 class="text-center">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-danger mr-2">Modifier mon projet</button>
                        </h3>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('administrateur.base_administrateur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/waribana/public_html/resources/views/administrateur/waricrowds/editer_waricrowd.blade.php ENDPATH**/ ?>