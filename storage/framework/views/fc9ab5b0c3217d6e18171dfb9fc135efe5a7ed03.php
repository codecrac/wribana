				...
				<div class="offset-md-3 col-md-6 text-left table-bordered p-2">
                    ...
                    <div class="about-text mb-lg-50">
						...
						<div class="container">
						    ...
						    <?php if( isset($_GET['use']) && $_GET['use'] == 'phone' ): ?>
                                <form class="form-group" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class='row'>
                                            <div class='col-md-8'>
                                                <input required class="form-control" placeholder="2250578765467" value="<?php echo e($code_prefixe); ?>" type="number"  onkeypress="return onlyNumberKey(event)" name="identifiant"
                                                                                       autocomplete="off" />
                                            </div>
                                            <div class='col-md-4'>
                                        <?php echo csrf_field(); ?>
                            ...
                            <?php if( isset($_GET['use']) && $_GET['use'] == 'email' ): ?>
                                <form class="form-group" method="post">
                            ...
                            <h3 class="text-center" >
                                <a href="<?php echo e(route('connexion_menbre')); ?>" class="btn btn-dark" >
...
<?php echo $__env->make('base_front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/waribana/public_html/resources/views/reinitialiser_mot_de_passe.blade.php ENDPATH**/ ?>